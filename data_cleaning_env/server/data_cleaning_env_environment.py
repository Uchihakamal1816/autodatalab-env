...
TASK_SPECS: Dict[str, Dict[str, Any]] = {
    ...
    "hard": {
        ...
        "max_steps": 42,
        "instruction": (
            "E-commerce Task 3 (Insight + visualization): clean orders — dedupe, impute missing Price (mean), "
            "then remove Price outliers (MAD z-score ≤ 2.5). Derive Revenue = Price × Quantity. "
            "Declare a scatter plot (OrderDate vs Revenue) and a bar chart (Category vs Revenue). "
